...
def generate_image_for_topic(post_topic: str):
    ...
    try:
        response = ai_client.images.generate(
            prompt=f"Create an illustration representing {post_topic} with a modern twist, avoiding any text or letters. Use abstract shapes and colors to give a contemporary feel, while incorporating {post_topic}-inspired themes",
            n=1,
            size="512x512",
        )
