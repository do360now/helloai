...
if not bearer_token:
    raise ValueError(
        "The BEARER_TOKEN environment variable is missing. Please set it and try again."
    )
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        user_id = input(
            "Enter the user ID of the account whose following list you want to retrieve: "
        )
